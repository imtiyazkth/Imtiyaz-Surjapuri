...
export const metadata = {
  title: "Terms of Use — ImtiyazSurjapuri.com",
  description: "Terms of Use for ImtiyazSurjapuri.com",
};
      ...
      <main style={{ flex:1 }}>
        <div className="main-container" style={{ maxWidth:"800px" }}>
          ...
          <div className="article-body" style={{ maxWidth:"none" }}>
            <p>
              By accessing and using <strong>ImtiyazSurjapuri.com</strong> (the &quot;Site&quot;),
            ...
            <p>
              To the maximum extent permitted by law, ImtiyazSurjapuri.com and its
